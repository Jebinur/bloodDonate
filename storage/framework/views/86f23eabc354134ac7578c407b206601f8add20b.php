                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flag" value="urgent"
                                                checked <?php echo e($bloodRequest->flag == 'urgent' ? 'checked' : ''); ?> />
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <textarea class="form-control form-control-lg" name="description" id="description" rows="6"><?php echo e($bloodRequest->description); ?></textarea>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blood-donation-hub\resources\views/frontend/user/reciever/edit_blood_request.blade.php ENDPATH**/ ?>