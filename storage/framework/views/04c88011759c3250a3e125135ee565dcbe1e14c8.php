         ...
         <tbody>
             <?php $__currentLoopData = $interested_in; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <tr>
                     ...
                     <td width="8%"><span class="badge <?php echo e($data->managed ? 'bg-success' : 'bg-warning'); ?>">
                     ...
                     <td width="10%">
                         <div>
                             <button class="btn btn-danger request-accept" data-bs-toggle="modal"
                                 ...
                                 request_id="<?php echo e($data->id); ?>" <?php echo e($data->accepted || $data->managed ? 'disabled' : ''); ?>>
                                 Cancel
                             </button>
                         </div>
...
<?php /**PATH C:\xampp\htdocs\blood-donation-hub\resources\views/frontend/user/donor/blood_requets_table.blade.php ENDPATH**/ ?>