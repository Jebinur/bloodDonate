    ...
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('search')); ?>"
            ...
            <input name="search_text" class="form-control form-control-lg w-100" type="text"
                placeholder="Search by locatoion" value="<?php echo e(@$search_string); ?>" required>
            <div class="mt-4">
...
<?php /**PATH E:\Freelance Projects\blood-donation-hub\resources\views/frontend/partials/search.blade.php ENDPATH**/ ?>