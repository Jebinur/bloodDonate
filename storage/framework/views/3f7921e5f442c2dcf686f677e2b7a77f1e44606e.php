                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    ...
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Update Blood Request</h3>
                            <form method="POST" action="<?php echo e(route('reciever.blood_request.edit', $bloodRequest->id)); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="name" name="name"
                                                class="form-control form-control-lg" value="<?php echo e($bloodRequest->name); ?>"
                                                required />
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-4 pb-2">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="tel" id="phone" name="phone"
                                                class="form-control form-control-lg" value="<?php echo e($bloodRequest->phone); ?>"
                                                required />
                                    ...
                                    <div class="col-md-6 mb-4 pb-2">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="email" id="emailAddress" name="email"
                                                class="form-control form-control-lg" value="<?php echo e($bloodRequest->email); ?>"
                                                required />
                                    ...
                                    <div class="col-md-6 mb-4 d-flex align-items-center">
                                        ...
                                        <div class="form-outline datepicker w-100">
                                            ...
                                            <input type="date" class="form-control form-control-lg" id="date"
                                                name="date" value="<?php echo e($bloodRequest->date); ?>" required />
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-4 d-flex align-items-center">
                                        ...
                                        <div class="form-outline datepicker w-100">
                                            ...
                                            <input type="text" class="form-control form-control-lg timepicker"
                                                id="time" name="time" value="<?php echo e($bloodRequest->time); ?>"
                                                autocomplete="off" />
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flag" value="urget"
                                                checked <?php echo e($bloodRequest->flag == 'urget' ? 'checked' : ''); ?> />
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flag"
                                                ...
                                                <?php echo e($bloodRequest->flag == 'pre_collection' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="col-md-6 mb-4 donorRules">
                                        ...
                                        <select class="select form-control-lg" name="blood_group_id" required>
                                            ...
                                            <?php $__currentLoopData = $bloodGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($bloodRequest->blood_group_id == $group->id ? 'selected' : ''); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <textarea class="form-control form-control-lg" name="description" id="description" rows="6">

                                                <?php echo e($bloodRequest->description); ?>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="location" name="location"
                                                ...
                                                value="<?php echo e($bloodRequest->location); ?>" required />

                                            <input type="text" hidden name="latitude" id="locationLat"
                                                value="<?php echo e($bloodRequest->latitude); ?>">
                                            <input type="text" hidden name="longitude" id="locationLng"
                                                value="<?php echo e($bloodRequest->longitude); ?>">
                                        </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-group form-check">
                                            <input type="checkbox" name="only_show_to_authorized"
                                                ...
                                                <?php echo e($bloodRequest->only_show_to_authorized ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelance Projects\blood-donation-hub\resources\views/frontend/user/reciever/edit_blood_request.blade.php ENDPATH**/ ?>