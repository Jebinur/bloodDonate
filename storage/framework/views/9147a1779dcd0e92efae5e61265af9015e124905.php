                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active"
                                        href="<?php echo e(route('user_settings.upload_profile_picture')); ?>">Upload Profile
                                        Picture</a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <div>
                                            <div class="card shadow-2-strong card-registration"
                                                ...
                                                <div class="card-body p-4 p-md-5">
                                                    <form method="POST" action="<?php echo e(route('avater.store')); ?>"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-4">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label" for="name">Profile
                                                                        Picture</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelance Projects\blood-donation-hub\resources\views/frontend/user/settings/upload_profile_picture.blade.php ENDPATH**/ ?>