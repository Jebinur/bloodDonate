                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('user_settings.change_blood_group')); ?>">Change Blood
                                        Group</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?php echo e(route('user_settings.change_password')); ?>">Change
                                        Password</a>
                                </li>
                            </ul>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelance Projects\blood-donation-hub\resources\views/frontend/user/settings/change_password.blade.php ENDPATH**/ ?>