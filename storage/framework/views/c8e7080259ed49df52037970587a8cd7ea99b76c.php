                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-blood-group-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-blood-group" type="button" role="tab"
                                        aria-controls="pills-blood-group" aria-selected="true">Change Blood Group</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-password-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-password" type="button" role="tab"
                                        aria-controls="pills-password" aria-selected="false">Change Password</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-blood-group" role="tabpanel"
                                    aria-labelledby="pills-blood-group-tab">
                                    ...
                                    <div class="row justify-content-center align-items-center h-100">
                                        <div>
                                            ...
                                            <div class="card shadow-2-strong card-registration"
                                                ...
                                                <div class="card-body p-4 p-md-5">
                                                    <form method="POST"
                                                        action="<?php echo e(route('user_settings.change_password')); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="row">
                                                            <div class="col-md-12 mb-4">

                                                                <div class="form-outline">
                                                                    <label class="form-label" for="name">Old
                                                                        Password</label>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-md-12 mb-4">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label" for="name">New
                                                                        Password</label>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-md-12 mb-4">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label" for="name">Confirm New
                                                                        Password</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelance Projects\blood-donation-hub\resources\views/frontend/user/settings/blood_group.blade.php ENDPATH**/ ?>